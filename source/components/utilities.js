 ...
 */
export const isHex = (str) => /^#([a-f\d]{3}|[a-f\d]{6})$/i.test(str);

/**
 * Convert value to a 2-digit hexadecimal string
 */
export const toHex = (val) => clamp(0, 255, val).toString(16).padStart(2, '0');
...
/**
 * String & UI Formatting
 */
export const truncate = (str, limit = 40) => str?.length > limit ? `${str.slice(0, limit)}…` : str;

/**
 * Replace underscores with spaces and convert to lowercase
 */
export const formatLabel = (str) => str.replace(/_/g, ' ').toLowerCase();

/**
 * CLI Visual Generators
 */
