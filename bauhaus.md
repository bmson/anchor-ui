...
**Philosophy:**
Strict geometric purity. Form follows function. Rely heavily on rigid mathematical grids.
...
- **Core Constraint:** Color palette is strictly limited to Pure Red, Pure Blue, Pure Yellow, Black, and Off-White.
- **Rhythm & Grid:** Rigid. Adjust padding to feel Comfortable.
- **Emphasis & Hierarchy:** Structural emphasis. Communicate importance via Flat methods.
- **Interaction Feel:** Mechanical and structured.
...
- [ ] **Negative Constraint:** No soft shadows, no gradients, no secondary colors, no rounded corners.
