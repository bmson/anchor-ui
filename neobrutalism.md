...
**Philosophy:**
Loud, high-contrast, and unapologetic. Raw structural elements and harsh shadows.
...
- **Core Constraint:** Must use thick solid borders and sharp, unblurred offset shadows.
- **Rhythm & Grid:** Modular. Adjust padding to feel Comfortable.
- **Emphasis & Hierarchy:** Tactile emphasis. Communicate importance via Z-Axis methods.
- **Interaction Feel:** Harsh, instant, and tactile.
...
When creating animations or transitions, animate ONLY composite properties: `transform`, `opacity`, and `filter`. NEVER animate `width`, `height`, `margin`, `padding`, or `box-shadow` if `Expressive` is Fluid or higher, as this triggers layout repaints.
...
- [ ] **Negative Constraint:** No soft blurs, no gradients, no subtle grays, no borderless cards.
...
- [ ] Are animations strictly adhering to the `Expressive` rules and durations?
